...
class UserInputField(UserControl):
    ...
    def return_email_prefix(self, e):
        ...
        if e.control.data in email:
            ...
            self.controls[0].content.controls[2].opacity = 10
            self.update()

    def prefix_email_containers(self):
        email_labels = ["@gmail.com", "@xvideos.com"]
        label_title = ["GMAIL", "XVIDEOS"]
        _row = Row(spacing=0, alignment=MainAxisAlignment.END)
        for index, label in enumerate(email_labels):
            _row.controls.append(
                Container(
                    ...
                    content=Text(label_title[index], size=8,color="white" ,weight="bold"),
                    data=label,
                ...
                content=Column(
                    ...
                    controls=[
                        ...
                        Column(
                            ...
                            spacing=5,
                            controls=[
                                Text("Loguéate aquí abajo", size=22, weight="bold", color="white"),
                                Text(
                                    "Logueate para ser ING.",
                                    size=13,
                                    weight="bold",
                                    color="white"
                                ),
